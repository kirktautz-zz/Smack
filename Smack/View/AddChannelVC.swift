...
class AddChannelVC: UIViewController {
    ...
    @IBAction func createChannelPressed(_ sender: RoundedButton) {
        ...
        guard let channelDescription = channelField.text, channelField.text != "" else { return }
    ...
    func setupView() {
        ...
        channelField.attributedPlaceholder = NSAttributedString(string: "description", attributes: [NSAttributedStringKey.foregroundColor : SMACK_PURPLE_PLACEHOLDER])
    }
